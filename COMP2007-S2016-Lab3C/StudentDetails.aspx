<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentDetails.aspx.cs" Inherits="COMP2007_S2016_Lab3C.StudentDetails" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Invalid Date! Format: mm/dd/yy"
